...
class Lead(db.Model):
    ...
    fullname = db.Column(db.VARCHAR(50))
    budget =db.Column(db.FLOAT)
    phone =db.Column(db.FLOAT)
    company_age = db.Column(db.VARCHAR(50))
    service = db.Column(db.VARCHAR(50))
    timeline = db.Column(db.VARCHAR(50))
    range = db.Column(db.VARCHAR(50))
    project_summary = db.Column(db.VARCHAR(50))
    website = db.Column(db.VARCHAR(50))
    company_name = db.Column(db.VARCHAR(50))
...
class Work(db.Model):
    ...
    project_summary = db.Column(db.VARCHAR(50))
    services = db.Column(db.VARCHAR(50))
